...
export const HeroSection = () => {
  return (
    <section className="w-full relative overflow-hidden pt-40">
      <div className="absolute top-[-72%] w-full h-[1800px] z-0 rounded-full bg-gray-50 left-0"></div>
      <div className="mx-auto max-w-5xl relative z-10 pb-28">
